-- DROP PROCEDURE financial_statements.financial_2023_v1();

CREATE OR REPLACE PROCEDURE financial_statements.financial_2023_v1()
 LANGUAGE plpgsql
AS $procedure$
DECLARE
    i INT;
...
BEGIN
    ...
    FOR i IN 1..4 LOOP
        ...
        table_name := format('2023_%s', LPAD(i::TEXT, 2, '0'));
