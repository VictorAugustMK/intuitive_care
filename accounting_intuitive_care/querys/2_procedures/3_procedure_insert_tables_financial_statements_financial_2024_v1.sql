-- DROP PROCEDURE financial_statements.financial_quarter_2024_v1();

CREATE OR REPLACE PROCEDURE financial_statements.financial_quarter_2024_v1()
 LANGUAGE plpgsql
AS $procedure$
DECLARE
    i INT;
...
BEGIN
    FOR i IN 1..4 LOOP
        ...
        table_name := format('financial_statements.%I', format('2024_0%s', i));
        temp_table := format('financial_statements_temp_2024_0%s', i);
        file_path := format('C:\\repo\\intuitive_care\\accounting_intuitive_care\\financial_statements\\2024\\%sT2024.csv', i);
