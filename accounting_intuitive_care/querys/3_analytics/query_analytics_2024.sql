...
FROM 
	financial_statements."2024_01" as tri_01 -- Altere entre 2024_01, 2024_02, 2024_03, 2024_04
...
FROM 
	(
		...
		FROM
			financial_statements."2024_01" as tri_01
		WHERE
			tri_01.descricao like '%EVENTOS/ SINISTROS CONHECIDOS OU AVISADOS  DE ASSISTÊNCIA A SAÚDE MEDICO HOSPITALAR %'
		...
		FROM 
			financial_statements."2024_02" as tri_02
		WHERE
		...
		FROM 
			financial_statements."2024_03" as tri_03
		WHERE
		...
		FROM 
			financial_statements."2024_04" as tri_04
		WHERE
